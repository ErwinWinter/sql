...
VALUES ('Hanif', 'Jl. Babakan loa no. 22', 'L');
SAVEPOINT POINT1;
...
INSERT INTO pasien (nama_pasien, alamat_pasien, jenis_kelamin)
VALUES ('Lutfhi', 'Jl. Dipenogoro no 24', 'L');
...
INSERT INTO pasien (nama_pasien, alamat_pasien, jenis_kelamin)
VALUES
('Hanif', 'Jl. Babakan loa no.11', 'L');
ROLLBACK;

UPDATE pasien 
SET nama_pasien = 'Winter'
WHERE id_pasien = 1;
...
(2, 'D1012', 'Omeprazole', 200000, 20),
(3, 'D1101', 'Ibuprofen Syrup', 20000, 30),
(4, 'D1102', 'Amoxicillin', 25000, 35),
...
(1, 'Winter', 'Jl. Merdeka No. 12, Jakarta', 'L'),
...
--
ALTER TABLE `obat`
  MODIFY `id_obat` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
